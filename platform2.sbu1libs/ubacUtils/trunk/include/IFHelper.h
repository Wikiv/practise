...
namespace UBAC {
	/// Class IFHelper. Implements helper functions for generic stuff.
	class IFHelper {
		public:
			IFHelper();
			~IFHelper();
            ...
            /** Formats double values to a string without any precision, useful when 
             * no precision is required and no change in value. */
