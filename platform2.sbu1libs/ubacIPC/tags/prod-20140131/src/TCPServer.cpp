...
#ifdef _WIN32
		int clientId = accept(descriptor, (struct sockaddr *) &client_address, (int *)&sockaddr_in_len);
#else
...
#else
		int clientId = accept(descriptor, (struct sockaddr *) &client_address, &sockaddr_in_len);
#endif
#endif
		if( clientId > 0 )
