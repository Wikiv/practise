...
int main()
{
    double d = -10029999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999.234;

    string value;

    IFHelper ifHelper;

    string s = ifHelper.formatDouble(1.02);
