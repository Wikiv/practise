		...
		public JsonBool
	{
		public:
			...
			* <a href="http://www.cplusplus.com/reference/map/map/operator[]/">Please refer here for more details</a> */
			...
			JsonObject getJsonObject(string sKey) ;
...
//			JsonObject magicObject;
		...
		public:
			...
			int reformat_string(const unsigned char * stringVal, size_t stringLen);
			int reformat_map_key(const unsigned char * stringVal, size_t stringLen);
			int reformat_start_map();
			int reformat_end_map();
			int reformat_start_array();
			int reformat_end_array();
			int reformat_integer(long long i);
