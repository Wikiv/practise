...
//	len+= unprocessed_bytes;
	...
	while(this->current_packet_size && unprocessed_bytes >= this->current_packet_size){
		...
		memcpy(this->buffer, ((uint8_t*)this->buffer)+ this->current_packet_size , this->unprocessed_bytes - this->current_packet_size );
		//printf("2: buffer: %s, current_packet_size: %ld, unprocessed_bytes: %ld \n", (char*)this->buffer, this->current_packet_size, unprocessed_bytes);

		bzero(((uint8_t*)this->buffer)+unprocessed_bytes, this->unprocessed_bytes-current_packet_size);
		...
		bzero(((uint8_t*)this->buffer)+unprocessed_bytes,this->buffer_max_size-unprocessed_bytes );
