...
BrokerLogoutRequest::BrokerLogoutRequest(string data) : string(data)
{
	parse(data);
}

BrokerLogoutRequest::~BrokerLogoutRequest()
{
}

void BrokerLogoutRequest::parse(string data)
{
...
string BrokerLogoutRequest::getOtherParams( string name )
{
	string value;
...
string BrokerLogoutRequest::toString()
{
	string s = "444 <";
	s = s + (*this) + ">";
	return s;
