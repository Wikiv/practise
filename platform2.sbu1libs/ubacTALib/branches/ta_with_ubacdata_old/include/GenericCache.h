...
namespace UBAC {
		...
		public map<KeyType, GenericCacheItem>
	{
		public:
			...
			bool isCached(KeyType key, typename map<KeyType, GenericCacheItem>::iterator & iCacheMap)
			{
				typename map<KeyType, GenericCacheItem>::iterator iTmpCacheMap = this->find( key );
