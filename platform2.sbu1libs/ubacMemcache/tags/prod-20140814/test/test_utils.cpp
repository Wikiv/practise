...
void fillData() 
{
    MemCache * m = new MemCache("localhost", 11211, "string-namespace");
    ...
    m = new MemCache("localhost", 11211, "struct-namespace");
...
int main()
{
    ...
    MemcacheUtils * memUtils = new MemcacheUtils("localhost", 11211, "struct-namespace");
    ...
    memUtils = new MemcacheUtils("localhost", 11211, "string-namespace");
